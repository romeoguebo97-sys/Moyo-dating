  ...
  return (
    <AuthLayout onBack={() => onNav("landing")}>
      ...
      {step === 2 && <>
        ...
        <div style={{ marginBottom: 18 }}>
          <label style={{ display: "block", fontWeight: 500, marginBottom: 7, fontSize: "0.88rem", color: G.brunLight }}>Religion (optionnel)</label>
