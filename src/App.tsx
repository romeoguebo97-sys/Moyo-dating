  ...
  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
    ...
    <div style={{ position: "relative" }}>
      <div
        ...
        style={{ width: 42, height: 42, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 4, cursor: "pointer", padding: 6, borderRadius: 10, WebkitTapHighlightColor: "transparent", touchAction: "manipulation" }}
      >
        {[0,1,2].map(i => <div key={i} style={{ width: 18, height: 2.5, borderRadius: 2, background: "#555" }} />)}
      </div>
    </div>
  </div>
