  ...
  return (
    <AuthLayout onBack={() => onNav("landing")}>
      ...
      {step === 2 && <>
        ...
        <Input label="Âge" type="number" value={form.age} onChange={e => { const v = e.target.value.slice(0,2); if(!v || (parseInt(v) >= 18 && parseInt(v) <= 99)) upd("age", v); }} placeholder="Ex: 25" icon="🎂" hint="Entre 18 et 99 ans" />
        <div style={{ marginBottom: 18 }}>
