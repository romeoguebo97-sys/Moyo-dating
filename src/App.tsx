        ...
        <div className="landing-hero" style={{ padding: "52px 24px 0", textAlign: "center", alignItems: "flex-end" }}>
          ...
          <div className="landing-hero-text fu1" style={{ paddingBottom: 52 }}>
            ...
            <div className="fu4 landing-hero-btns" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap", marginBottom: 32 }}>
              ...
              <button className="btn-o" onClick={() => onNav("login")} style={{ border: "1.5px solid rgba(44,26,14,0.25)", borderRadius: 50, padding: "13px 28px", fontWeight: 500, fontSize: "0.95rem", background: "rgba(255,255,255,0.35)", color: G.brunLight, cursor: "pointer", backdropFilter: "blur(4px)", fontWeight: 700 }}>
                Me connecter
              </button>
            </div>
          </div>
